...
<div class="modal fade" id="create" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('pacientes.store')}}" method="post" enctype="multypart/form-data">
                @csrf
                <div class="modal-body">
                    ...
                    <input type="text" name="numero_ambulatorio" id="numero_ambulatorio" class="form-control">
                    <label for="nivel_ambulatorio">Nivel Ambulatorio</label>
                    <input type="text" name="nivel_ambulatorio" id="nivel_ambulatorio" class="form-control">
